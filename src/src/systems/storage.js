 ...
 * Scopes are separated into world / module / player, and values are JSON-encoded to support objects, arrays, and primitives.
 */
...
// Prefix used to prevent Library keys from colliding with other Dynamic Properties.
...
// Create the same store facade for world/module/player while changing only the target and scope.
...
// The world store is created once because the world is a global target.
...
// The player store is derived from player.id, keeping each player in a separate namespace.
