/**
 * Central event bus for the Library
 * Native Minecraft events are bridged into event names controlled by the Library.
 * This lets other modules subscribe/emit without depending directly on @minecraft/server.
 */

import { log } from './logger.js';

// eventName -> listener entries; listeners are grouped by event name
const bus = new Map();
...
function emit(name, data) {
    ...
    // The snapshot is important: listeners can be removed or added during emit without corrupting the iteration.
...
// Bridge Bedrock native afterEvents into the Library event bus
