/**
 * Centralized error handling for the Library
 * guard/guardAsync prevent exceptions from the Minecraft API from breaking the main system.
 * assert is for conditions considered programming errors and should throw.
 */
