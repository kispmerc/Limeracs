/**
 * Central logger: supports levels, namespaces, and a custom sink
 * Every subsystem can create its own logger, such as log.create('storage').
 */
...
// Logger state is a singleton so setLevel/setSink affects loggers in every namespace.
