/**
 * Block API: a small abstraction around Dimension.getBlock and block mutation.
 * Every world operation goes through guard so a fallback can be returned when the native API throws.
 */
